...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(package='task_1_wheeled_robot', executable='noise_injector_node', output='screen'),
        Node(package='task_1_wheeled_robot', executable='ekf_node', output='screen'),
        Node(package='task_1_wheeled_robot', executable='motion_node', output='screen'),
    ])
